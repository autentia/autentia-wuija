 ...
 */
public class Link extends JsfWidget {
	...
	public Link(String labelId, ActionListener actionListener) {
		this(labelId, actionListener, false);
	}

	public Link(String labelId, ActionListener actionListener, boolean immediate) {
	...
	public String getRendererPath() {
		return RENDERER_PATH + "link.jspx";
	}
