...
public class AdvancedQueryNoSearchAndClearButtons extends AdvancedQuery {

	public AdvancedQueryNoSearchAndClearButtons(Property[] properties, Criteria criteria) {
		super(properties, criteria);
	}
	
	@Override
	public String getRendererPath() {
		return RENDERER_PATH + "advancedQueryNoSearchAndClearButtons.jspx";
	}
