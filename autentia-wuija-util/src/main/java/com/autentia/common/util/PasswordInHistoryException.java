...
public class PasswordInHistoryException extends PasswordException {

	private static final long serialVersionUID = 7303482416074521191L;

	public PasswordInHistoryException() {
		super("ChangePassword.passwordInHistory");
	}
