 ...
 */
public class OpenTransactionInViewPatternJSFBeforeRestoreViewListener implements PhaseListener {

	private static final long serialVersionUID = 1L;

	public static Log log = LogFactory.getLog(OpenTransactionInViewPatternJSFBeforeRestoreViewListener.class);

	public void afterPhase(PhaseEvent phaseEvent) {
		// No hay que hacer nada después de la fase
	}
